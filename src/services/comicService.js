...
const getComicById = async (id, token) => {
    try {
        const response = await axios.get(`http://localhost:8080/api/comics/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            }
        })
...
export {createComic, getAllComics, getComicById, updateComic, deleteComic};