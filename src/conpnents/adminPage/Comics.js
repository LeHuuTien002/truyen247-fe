...
const Comics = () => {
    ...
    // State chứa các thể loại đã chọn
    const [selectedGenres, setSelectedGenres] = useState([]);

    // Xử lý khi thay đổi lựa chọn trong dropdown
    const handleChange = (selectedOptions) => {
        setSelectedGenres(selectedOptions || []); // Cập nhật danh sách thể loại đã chọn
    };
    ...
    const handleSearch = (searchTerm) => {
        if (searchTerm === '') {
            setFilteredData(comicList); // Nếu không có từ khóa, hiển thị toàn bộ dữ liệu
        } else {
                        ...
                        <div className="modal-body">
                            ...
                            <form onSubmit={handleCreateSubmit} className="container">
                                ...
                                <div className="mb-3">
                                    ...
                                    <Select
                                        id="selectedGenres"
                                        options={genreOptions} // Danh sách tất cả các thể loại
                                        isMulti // Cho phép chọn nhiều thể loại
                                        styles={customStyles}
                                        onChange={handleChange} // Hàm xử lý khi thay đổi lựa chọn
                                                    ...
                                                    <form onSubmit={handleUpdateSubmit} className="container">
                                                        ...
                                                        <div className="mb-3">
                                                            ...
                                                            <Select
                                                                id="selectedGenres"
                                                                options={genreOptions} // Danh sách tất cả các thể loại
                                                                value={selectedGenres} // Danh sách thể loại đã chọn
                                                                isMulti // Cho phép chọn nhiều thể loại
                                                                styles={customStyles}
                                                                onChange={handleChange} // Hàm xử lý khi thay đổi lựa chọn
                                                                placeholder="Chọn thể loại"
